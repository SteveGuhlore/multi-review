# gemini-review.ps1 — read-only Gemini reviewer wrapper for /multi-review.
#
...
$prompt | gemini -p "Follow the review instructions in the input above and return ONLY the requested output (no preamble)." --approval-mode plan 2>$null
